 ...
 */
public class UbProductListTwoAdapter extends BaseAdapter{
    ...
    public UbProductListTwoAdapter(Context context, List<ProductListBean> dataList) {
...
//    }
    ...
    public View getView(int index, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holderView.produce_month = (LinearLayout)convertView.findViewById(R.id.produce_month);
        ...
        final ProductListBean product1 = dataList.get(position1);
        holderView.tv_detail1.setText(product1.name);
        holderView.tv_score1.setText(product1.count_month+"");
        holderView.tv_price1.setText(product1.price+"");
        Tools.ImageLoaderShow(context,BASE_IMAGE_URL+product1.icon, holderView.iv_logo1);
        if (position2 < dataList.size()) {
            final ProductListBean product2 = dataList.get(position2);
            ...
            holderView.tv_detail2.setText(product2.name);
            holderView.tv_score2.setText(product2.count_month+"");
            holderView.tv_price2.setText(product2.price+"");
