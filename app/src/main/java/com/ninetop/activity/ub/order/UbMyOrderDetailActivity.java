...
public class UbMyOrderDetailActivity extends BaseActivity {
    ...
    private void initOrderDetails(MyOrderListBean result) {
        ...
        tvProductPri.setText(TextConstant.MONEY + result.totalPay);
        ...
        if ("".equals(result.sendTime)) {
            ...
            tvOrderSendTime.setText("付款时间 ：" + result.payTime.substring(0, result.payTime.indexOf(".")));
        }
        ...
        if ("".equals(result.totalPay)) {
            ...
            tvTotalPrice.setText("合计  " + TextConstant.MONEY + result.totalPay + "");
        }
    ...
    private void confirmGet(int orderId) {
        ubProductService.postConfirmReceive(orderId, new CommonResultListener(this) {
            @Override
