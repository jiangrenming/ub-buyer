...
import static com.ninetop.common.IntentExtraKeyConst.COMPLAINTID;
import static com.ninetop.common.IntentExtraKeyConst.EVALUATEGOODSLIST;
import static com.ninetop.common.IntentExtraKeyConst.GOODS_CODE;
import static com.ninetop.common.IntentExtraKeyConst.ORDER_CODE;
import static com.ninetop.common.IntentExtraKeyConst.REALPAY;
import static com.ninetop.common.IntentExtraKeyConst.SKUID;
...
public class OrderDetailsActivity extends BaseActivity implements OnClickListener {
    ...
    //确认收货service
    private void confirmGoods(OrderDetailsBean result) {
        service.confirmGoods(result.orderCode, new CommonResultListener<String>(OrderDetailsActivity.this) {
            @Override
            public void successHandle(String result) {
                finish();
                startActivity(MyOrderActivity.class);
