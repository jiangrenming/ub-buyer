 ...
 */
public class SellerNearListAdapter extends BaseAdapter {
    Context context;
    List<SellerBean> dataList;
    public SellerNearListAdapter(Context context, List<SellerBean> dataList) {
    ...
    public View getView(final int index, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holderView.ll_local=(LinearLayout)convertView.findViewById(R.id.ll_location);
        ...
        holderView.tv_ub_ratio.setText("U币赠送比例 "+seller1.getRatio());
         holderView.ll_local.setVisibility(View.VISIBLE);
