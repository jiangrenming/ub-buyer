...
public class PictureUtils {
    ...
    public static void convertWashcarTakePicture(String filepath,Context context){
        ...
        // 获取屏幕的高度和宽度
        int height = com.ninetop.common.util.GestureUtils.getScreenPix (context).heightPixels;
        int width = com.ninetop.common.util.GestureUtils.getScreenPix (context).widthPixels;
