...
import static com.ninetop.common.constant.UrlConstant.EVALUAT;
...
public class OrderService extends BaseService {
    ...
    //确认收货
    public void confirmGoods(String code, ResultListener<String> resultListener) {
        HashMap<String, String> params = new HashMap();
        params.put("code", code);
        post(UrlConstant.CONFIRM_GOODS, params, new BaseResponseListener(context, resultListener) {
            @Override
            public void success(JSONObject jsonObject) throws JsonSyntaxException, JSONException {
                String code = jsonObject.getString("code");
                if (SUCCESS.equals(code)) {
