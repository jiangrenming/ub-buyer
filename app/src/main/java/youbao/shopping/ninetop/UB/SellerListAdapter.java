...
public class SellerListAdapter extends BaseAdapter {
    ...
    public SellerListAdapter(Context context, List<SellerBean> dataList) {
    ...
    public View getView(final int index, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holderView.tv_ub_local = (TextView) convertView.findViewById(R.id.tv_location_distance);
            ...
            holderView.ll_location = (LinearLayout) convertView.findViewById(R.id.ll_location);
        ...
        holderView.tv_ub_ratio.setText("积分赠送比例："+seller1.getRatio());
        if(seller1.getDistance()!=null){
            holderView.ll_location.setVisibility(View.VISIBLE);
            holderView.tv_ub_local.setText(" "+seller1.getDistance()+"KM");
        }
