...
import youbao.shopping.ninetop.UB.ProductCategoryBean;
...
public class UbProductService extends BaseService {
    ...
    public void postAddFranchisee(int franchid, ResultListener resultListener) {
        String franchiseeId =String.valueOf(franchid);
        if (TextUtils.isEmpty(franchiseeId)) {
            franchiseeId = "\"\"";
        }
...
//    }
    ...
    //确认收货
    public void postConfirmReceive(int id,String password,ResultListener resultListener) {
