package youbao.shopping.ninetop.common.constant;
...
//    public static final String SHOPCART_LIST = "carts";
//
//    public static final String SHOPCART_ADD = "carts";
    ...
    //二级分类
    //public static final String second_category = "categories/";
    //二级分类商品列表
    ...
    //订单详情
    //public static final String ORDER_DETAILS = "orders/{code}
    //商品评价
    ...
    //获取验证码
    //public static final String AUTHCODE = "buyers/authCode";
    //明细
    ...
    //    //ub热门城市列表
//    public static final String HOT_CITY = "hotycity";
    //ub商家距离
    public static final String DISTANCE_SELLER = "union_shop/get_distance";
//    //ub首页banner列表
//    public static final String UB_BANNER = "user/receiver/delete";
    ...
    //自动更新
    public static String APP_UPDATE = "version/latest/detail";//弃用
    ...
    //用户分享
    public static String SHARE_URL = "user/MyInvitationCode";
}
