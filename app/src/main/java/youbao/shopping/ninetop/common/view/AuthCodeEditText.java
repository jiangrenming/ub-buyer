...
public class AuthCodeEditText extends LinearLayout implements Validatable{
	...
	public AuthCodeEditText(Context context, AttributeSet attrs) {
		...
		View view = inflater.inflate(R.layout.view_input_code, this);

		tv_get_code = (TextView) view.findViewById(R.id.tv_get_code);
		et_authcode = (EditText) view.findViewById(R.id.et_authcode);
	...
	public String getText(){
		return et_authcode.getText().toString().trim();
	}
