...
import youbao.shopping.ninetop.UB.SellerListAdapter;
...
import youbao.shopping.ninetop.activity.ub.product.HuangChangeActivity;
import youbao.shopping.ninetop.activity.ub.product.MyViewPagerAdapter;
...
//        mLocationClient.unRegisterLocationListener(this);
    ...
    protected void getServerData() {
        ubSellerService.getSellerList(mSelectCity, 1, 99, new CommonResultListener<List<SellerBean>>(this) {
            @Override
