 ...
 */
public class UbProductListAdapter extends BaseAdapter{
    private Context context;
    private List<ProductSearchBean> dataList;

    private View.OnClickListener showMoreClickListener = null;

    public UbProductListAdapter(Context context, List<ProductSearchBean> dataList) {
...
//    }
    ...
    public View getView(int index, View convertView, ViewGroup parent) {
        ...
        holderView.tv_score1.setText(product1.getCount_month()+"");
        holderView.tv_price1.setText(Math.round(Double.valueOf(product1.getPrice()))+"");

        Tools.ImageLoaderShow(context,BASE_IMAGE_URL+product1.getIcon(), holderView.iv_logo1);
        ...
        if (position2 < dataList.size()) {
            ...
            Tools.ImageLoaderShow(context, BASE_IMAGE_URL+product2.getIcon(), holderView.iv_logo2);
            holderView.tv_detail2.setText(product2.product_name);
            holderView.tv_score2.setText(product2.getCount_month()+"");
            holderView.tv_price2.setText(Math.round(Double.valueOf(product2.getPrice()))+"");
            ...
            holderView.ll_product2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra(IntentExtraKeyConst.PRODUCT_ID, product2.getProduct_id()+"");
        ...
        holderView.ll_product1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, UbProductInfoActivity.class);
                intent.putExtra(IntentExtraKeyConst.PRODUCT_ID, product1.getProduct_id()+"");
