...
import youbao.shopping.ninetop.bean.ShareAppBean;
import youbao.shopping.ninetop.common.LoginAction;
import youbao.shopping.ninetop.common.util.cleanCatchUtils;
...
//    private UMShareAPI mShareAPI;
    ...
    private void getAppCatch() {
        ...
        cleanCatchUtils.getAppCatch(this, new cleanCatchUtils.OnGetCleanSizeCallBack() {
            @Override
...
//                .open();
    ...
    private void clearBuffer() {
        cleanCatchUtils.cleanCatch(this, new cleanCatchUtils.ClearCache() {
            @Override
